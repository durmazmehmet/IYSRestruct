USE [SfdcMasterData]
GO
/****** Object:  StoredProcedure [dbo].[CreateConsentRequests_BOPK]    Script Date: 8/20/2020 1:19:26 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[CreateConsentRequests_BOPK]
AS BEGIN 
...
BEGIN 
	...
	-- BOI Permission
	IF CHARINDEX('Email',@Premium_Kiralama_Campaign_Permissions__pc) > 0 AND ISNULL(@PersonEmail, '') <> '' 
	BEGIN
		...
		VALUES('BOPK',@Id, @BOPKIysCode, @BOPKBrandCode, CONVERT(VARCHAR, @BOPKETKDate__c, 20),@BOPKETKSource__c, @PersonEmail, 'BIREYSEL','ONAY', 'EPOSTA', GETDATE());
		IF @IYSType__c <> 'Birey'	
			INSERT INTO SfdcMasterData.dbo.IysConsentRequestTemp
				(CompanyCode, SalesforceId, IysCode, BrandCode, ConsentDate, [Source], Recipient, RecipientType, Status, [Type], CreateDate)
			VALUES('BOPK',@Id, @BOPKIysCode, @BOPKBrandCode, CONVERT(VARCHAR, @BOPKETKDate__c, 20),@BOPKETKSource__c, @PersonEmail, 'TACIR','ONAY', 'EPOSTA', GETDATE());
	END
	...
	BEGIN
		...
		IF CHARINDEX('Telefon',@Premium_Kiralama_Campaign_Permissions__pc) > 0 
		BEGIN
			INSERT INTO SfdcMasterData.dbo.IysConsentRequestTemp
				(CompanyCode, SalesforceId, IysCode, BrandCode, ConsentDate, [Source], Recipient, RecipientType, Status, [Type], CreateDate)
			VALUES('BOPK',@Id, @BOPKIysCode, @BOPKBrandCode, CONVERT(VARCHAR, @BOPKETKDate__c, 20),@BOPKETKSource__c, @PersonMobilePhone, 'BIREYSEL','ONAY', 'ARAMA', GETDATE());
			IF @IYSType__c <> 'Birey'	
				INSERT INTO SfdcMasterData.dbo.IysConsentRequestTemp
					(CompanyCode, SalesforceId, IysCode, BrandCode, ConsentDate, [Source], Recipient, RecipientType, Status, [Type], CreateDate)
				VALUES('BOPK',@Id, @BOPKIysCode, @BOPKBrandCode, CONVERT(VARCHAR, @BOPKETKDate__c, 20),@BOPKETKSource__c, @PersonMobilePhone, 'TACIR','ONAY', 'ARAMA', GETDATE());
		END
		
		IF CHARINDEX('SMS',@Premium_Kiralama_Campaign_Permissions__pc) > 0 
		BEGIN
			INSERT INTO SfdcMasterData.dbo.IysConsentRequestTemp
				(CompanyCode, SalesforceId, IysCode, BrandCode, ConsentDate, [Source], Recipient, RecipientType, Status, [Type], CreateDate)
			VALUES('BOPK',@Id, @BOPKIysCode, @BOPKBrandCode, CONVERT(VARCHAR, @BOPKETKDate__c, 20),@BOPKETKSource__c, @PersonMobilePhone, 'BIREYSEL','ONAY', 'MESAJ', GETDATE());
			IF @IYSType__c <> 'Birey'	
				INSERT INTO SfdcMasterData.dbo.IysConsentRequestTemp
					(CompanyCode, SalesforceId, IysCode, BrandCode, ConsentDate, [Source], Recipient, RecipientType, Status, [Type], CreateDate)
				VALUES('BOPK',@Id, @BOPKIysCode, @BOPKBrandCode, CONVERT(VARCHAR, @BOPKETKDate__c, 20),@BOPKETKSource__c, @PersonMobilePhone, 'TACIR','ONAY', 'MESAJ', GETDATE());
		END
