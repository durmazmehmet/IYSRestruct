...
using IYS.Application.Services.Models.Response.Retailer;
...
public class RetailersController : ControllerBase
{
    ...
    public async Task<ActionResult<ResponseBase<AddRetailerResponse>>> AddConsent(
        ...
        [FromBody] RetailerModel retailer)
    {
        var consentParams = _iysHelper.GetIysCode(companyCode);

        var iysRequest = new IysRequest<RetailerModel>
        {
        ...
        var result = await _clientHelper.Execute<AddRetailerResponse, RetailerModel>(iysRequest);
